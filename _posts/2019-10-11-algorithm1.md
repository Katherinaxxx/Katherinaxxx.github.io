...
![array](https://katherinaxxx.github.io/images/post/algorithm1/array.jpg#width-full){:height="70%" width="90%"}
...
因为收敛，所以累加计算$$S_n=\frac{n}{2}+\frac{n}{4}+\frac{n}{8}+...+4+2$$
则$$qS_n=\frac{n}{4}+\frac{n}{8}+\frac{n}{18}+...+2+2$$
