...
![v](https://katherinaxxx.github.io/images/post/GAN/v.jpg#width-full){:height="50%" width="50%"}

给定G，先最大化$V(G,D)$更新D，然后固定G，通过最小化$V(G,D)$更新G。算法如下：

![algorithm](https://katherinaxxx.github.io/images/post/GAN/algorithm.jpg#width-full){:height="50%" width="50%"}

G和D相互博弈最终会达到纳什均衡。大致训练过程如下：

![train](https://katherinaxxx.github.io/images/post/GAN/train.jpg#width-full){:height="50%" width="50%"}
